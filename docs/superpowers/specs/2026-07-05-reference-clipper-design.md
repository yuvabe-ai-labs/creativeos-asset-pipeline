...
> ## ⛔ RETIRED — 2026-07-28 (D82). Superseded by Client Moodboards (D81).
>
...
> **Client Moodboards (D81)** replaced it — same right-click capture gesture, but images stage
...
> model was chosen, and D82 in the roadmap records why it was dropped. Do not build from this doc.
...
**Date:** 2026-07-05
**Status:** ⛔ **RETIRED 2026-07-28 (D82)** — shipped 2026-07-05, removed 2026-07-28. Historical record.
