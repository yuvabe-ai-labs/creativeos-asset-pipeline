...
| ADR log `docs/superpowers/specs/2026-05-30-creativeos-staging-roadmap.md` | Record the decision (D87) |
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-30-creativeos-staging-roadmap.md` (append D87)
- Modify: `docs/superpowers/plans/2026-07-21-auth-stage-1-index.md`

- [ ] **Step 1 [Claude]: Append ADR D87**

Add to the ADR log (§7), after D83:

```markdown
### D87 — Migrations run through the Supabase CLI in CI; staging auto, production gated *(recorded 2026-07-21)*
...
git commit -m "docs(db): record migration-CI decision (D87) + update Stage 1 tracker"
```
