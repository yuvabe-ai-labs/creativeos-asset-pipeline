...
// its own bucket, lifecycle and URL shape (D247, supersedes the design's Supabase bucket).
//
...
// stay in lib/storage.
//
// D249: one asset per annotation — the painted overlay. Video annotations used to carry a
