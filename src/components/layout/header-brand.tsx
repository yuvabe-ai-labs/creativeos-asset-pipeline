...
// the credits pill. The org/agency name lives in ProfilePopover's Workspace row, not here —
// see docs/superpowers/specs/2026-08-05-profile-popover-header-design.md.
