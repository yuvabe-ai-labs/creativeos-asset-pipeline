...
// created via the "New agency" dialog on /admin) never sees this. Not a redirect: a
// super_admin's default landing stays the normal app, scoped to their own org (D85) —
// /admin is an always-available side destination, not a takeover.
