    ...
    <div className="mb-5 flex items-center gap-3">
      <div className="group relative flex-1">
        ...
        <Input
          ...
          className="h-11 rounded-xl border-border bg-card pl-10 pr-4 text-[0.9rem] shadow-card transition-colors placeholder:text-muted-foreground/70 hover:border-foreground/15"
        />
      </div>
      ...
      <div className="relative">
        <select
          ...
          className={cn(
            ...
            "text-sm font-medium text-foreground shadow-card transition-colors",
