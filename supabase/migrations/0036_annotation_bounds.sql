-- D248 (supersedes D246): persist each annotation's painted bounding box.
--
...
comment on column node_version_annotations.bounds is
  'Painted region bbox as fractions of natural media size: {"x":0..1,"y":0..1,"w":0..1,"h":0..1}. Null for pre-D248 rows.';
